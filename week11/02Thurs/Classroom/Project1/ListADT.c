...
bool AddParticpantToList(PLIST thisList, PARTICIPANT thisParticipant)
{
...
void RemoveParticpantFromList(PLIST thisList, PARTICIPANT participantToBeDeleted)
{
	PLISTNODE current = thisList->list;
...
int GetCurrentCountFromList(LIST thisList)
{
	int count = 0;
	if (thisList.list == NULL)
		return count;

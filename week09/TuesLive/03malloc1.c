...
int main(void)
{
	...
	printf("enter size of array: ");
		...
		scanf("%d", &size);
	#endif
	int* dynArray = (int*)malloc(sizeof(GUY) * size);  //set aside a piece of memory for ourselves
	if (!dynArray)
	{
	...
	int* anotherptr = dynArray;
	dynArray = somethingelse;
	...
	free(anotherptr);		//always remember to free your memory
}
